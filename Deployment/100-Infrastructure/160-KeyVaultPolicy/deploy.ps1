...
Set-AzKeyVaultAccessPolicy -VaultName $KeyVaultName -ObjectId $currentUserObjectId -PermissionsToSecrets set,list,get -ErrorAction Continue

"Adding KV policy for servicePrincipal using objectId: $servicePrincipalObjectId"
Set-AzKeyVaultAccessPolicy -VaultName $KeyVaultName -ObjectId $servicePrincipalObjectId -PermissionsToSecrets set,list,get -ErrorAction Continue
